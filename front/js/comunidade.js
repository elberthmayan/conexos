...
export const Comunidade = {
    ...
    handleCreateCommunity(event) {
        ...
        const newCommunity = {
            ...
            name,
            description,
            banner: this.tempBannerFile ? URL.createObjectURL(this.tempBannerFile) : `https://placehold.co/600x240/1e1e1e/3a3b3c?text=${name.charAt(0)}`,
            avatar: this.tempAvatarFile ? URL.createObjectURL(this.tempAvatarFile) : `https://placehold.co/100x100/7e7ee3/FFFFFF?text=${name.charAt(0)}`,
            isJoined: true,
            level: 1,
            xp: 0,
