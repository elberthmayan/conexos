...
export const Notifications = {
    initialNotifications: [
        ...
        { id: '5', type: 'mention', user: 'Carlos Souza', avatar: 'https://i.pinimg.com/736x/32/b5/17/32b51754e1496531c11a027c9a185d24.jpg', message: 'mencionou você em um comentário.', isNew: false, postThumb: 'https://gameluster.com/wp-content/uploads/2023/05/vg.jpg', actionBtn: { text: 'Ver Comentário', class: 'btn-secondary', action: 'view-post'}},
    ],
    notifications: [],
    activeTab: 'all',
    ...
    init() {
        ...
        // A simulação de novas notificações agora é controlada pelo EventManager
    },
    ...
    addNotification(data) {
        ...
        // Apenas re-renderiza se a página de notificações estiver ativa
    ...
    renderNotifications() {
        ...
        const filters = {
            ...
            events: n => n.type === 'live_event', // ATUALIZADO
    ...
    getAlertTypeClass(type) {
        const typeMap = {
            ...
            live_event: 'type-event', // ATUALIZADO
            system: 'type-system'
        };
    ...
    appendNotification(n, listElement) {
         const iconMap = { follow: 'fa-user-plus', like: 'fa-heart', comment: 'fa-comment', 'community-invite': 'fa-users', mention: 'fa-at', live_event: 'fa-satellite-dish', system: 'fa-info-circle' }; // ATUALIZADO
         ...
         const liveIndicator = n.type === 'live_event' ? '<span class="live-indicator">AO VIVO</span>' : ''; // NOVO
    ...
    dismissNotification(id) {
        ...
        if(itemEl) {
             ...
             itemEl.addEventListener('transitionend', () => {
                this.notifications = this.notifications.filter(n => n.id != id); // Correção: != em vez de !== para comparar string com número
                this.saveNotifications();
                this.renderNotifications();
             }, { once: true });
        }
    ...
    handleNotificationAction(id, action, button) {
        const notification = this.notifications.find(n => n.id == id); // Correção: ==
        ...
        switch (action) {
            ...
            case 'accept-community':
                ...
                window.location.href = 'comunidade.html'; // Leva para a página de comunidades
                break;
            case 'view-profile': // NOVO
                 window.location.href = 'profile.html';
                 break;
            case 'view-community': // NOVO
