...
export const Profile = {
    ...
    // Referência aos jogos da loja (importado de gamedata.js idealmente, mas simulado aqui por simplicidade)
    storeGames: [ 
        { id: 'store1', title: 'Grand Theft Auto VI', image: 'https://cdn.mos.cms.futurecdn.net/25ttg5Qp7Mcr5sSMyGfS4A-970-80.jpg.webp' },
        { id: 'store2', title: 'Elden Ring: Shadow of the Erdtree', image: 'https://cdn.akamai.steamstatic.com/steam/apps/2778580/capsule_616x353.jpg?t=1708533808' },
        { id: 'store3', title: 'Hades II', image: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1145350/capsule_616x353.jpg?t=1715022933' },
        { id: 'store4', title: 'Counter-Strike 2', image: 'https://cdn.akamai.steamstatic.com/steam/apps/730/capsule_616x353.jpg?t=1695155293' },
    ],
    ownedGames: [],
    ...
    loadInitialData() {
        ...
        this.profilePicDisplay.src = sessionStorage.getItem('profilePicURL') || this.profilePicDisplay.src;
        this.profileNameDisplay.textContent = sessionStorage.getItem('profileName') || 'Seu Nome';
